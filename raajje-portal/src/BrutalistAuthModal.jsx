...
export default function BrutalistAuthModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <div className="bg-[#f4f1ea] border-[4px] border-black p-8 w-full max-w-md shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative">
        <button onClick={onClose} className="absolute top-4 right-4 text-2xl font-black hover:scale-125 transition-transform text-black">✕</button>
        
        <h2 className="text-3xl font-black uppercase tracking-tighter mb-2 italic text-black">Join the Republic</h2>
